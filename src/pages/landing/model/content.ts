...
export const TRUST_PILLARS: Array<{ icon: IconName; title: string; body: string }> = [
  ...
  {
    icon: 'consent',
    title: '이름·연락처 없이 비공개 보관',
    body: '질문 원음은 음성 인식 개선을 위해 90일간, 아이가 말한 문장과 캐릭터의 답은 서비스 개선을 위해 1년간 비공개로 보관하고, 이름·연락처는 가려요.',
  },
];
...
export const FAQ_ITEMS = [
  ...
  {
    q: '아이의 목소리를 저장하나요?',
    a: '아이의 질문 원음은 음성 인식 개선을 위해 90일간, 아이가 말하거나 쓴 문장과 캐릭터의 답은 서비스 개선을 위해 1년간 비공개로 보관합니다. 열람 화면은 없고, 이름·연락처 등 개인 식별 정보는 가려서 보관해요.',
  },
];
