...
const styles = StyleSheet.create({
  ...
  panelTitle: { fontSize: storybookTheme.type.md, fontWeight: '900', color: storybookTheme.color.onContent, marginBottom: 6 },
  storyRow: {
    gap: 2,
    paddingVertical: 12,
    borderTopWidth: 1,
  ...
  storyTitle: { fontSize: storybookTheme.type.sm, fontWeight: '700', color: storybookTheme.color.onContent },
  storyMeta: { fontSize: storybookTheme.type.xs, color: storybookTheme.color.onContentMuted },
});
