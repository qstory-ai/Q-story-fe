...
const styles = StyleSheet.create({
  ...
  consentTitle: { fontSize: storybookTheme.type.sm, fontWeight: '700', color: storybookTheme.color.onLightHeading },
  consentItem: { fontSize: storybookTheme.type.xs, lineHeight: 19, color: storybookTheme.color.onLightBody },
  inviteUrl: { fontSize: storybookTheme.type.xs, color: storybookTheme.color.linkOnLight, marginTop: 4 },
});
